...
- **2C. Amendment timeline.** V1 `d94d2c9`, A1 `2ac86c5`, A2 `03cc4d3`,
  ...
  A3.5 `560bf28` (tag `benchmark-content-freeze-a3-5`),
...
`MURU_PAPER_BENCHMARK_FREEZE.md`, the eight amendment documents (A1 to A3.5) and their
...
- **8A. Failure taxonomy.** A frozen map of every typed non-success state and
  ...
  `EXECUTION_FAILURE`, each of the eight acceptance gates, and each of the four
  hard falsification rungs (F1, F4, F7, F10). Under Amendment A3.5 the panel
  must additionally show F5 as superseded (its waiver-regime floor folded into
  gate 7) and F9 as computed-and-reported but never acceptance-determining, so
  no reader can infer a six-rung gate from the figure. **Can be drawn now.**
