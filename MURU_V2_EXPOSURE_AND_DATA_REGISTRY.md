...
- **MSnLib anchors (328 decoded of 402 census anchors, keys sha256 `b0c50630...c331`)**: exposed as calibration data (2026-09-13). The MSnLib validation population (census step 12b, 39,238 keys) is **not outcome-accessed**; headers were read only for the 561 anchor wells.
